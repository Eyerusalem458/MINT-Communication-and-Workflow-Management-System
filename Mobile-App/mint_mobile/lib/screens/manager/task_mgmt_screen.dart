...
class _TaskMgmtScreenState extends State<TaskMgmtScreen> {
  ...
  // FIX: pass providers into the bottom sheet so it can access TaskProvider and UserProvider
...
class _AssignTaskSheetState extends State<_AssignTaskSheet> {
  ...
  Future<void> _submit() async {
    ...
    if (_title.text.trim().isEmpty || _assignee == null || _dueDate == null) {
      debugPrint(
          'Validation failed: title=${_title.text}, assignee=$_assignee, due=$_dueDate');
    ...
    try {
      ...
      debugPrint('Submitting task data: $data');

      await context.read<TaskProvider>().assignTask(data);
      ...
      if (!mounted) return;
      setState(() => _busy = false);
      showSnack(context, 'Failed: ${e.toString()}', isError: true);
    }
  }
        ...
        child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<UserModel>(
                ...
                items: staff
                    .map((u) =>
                        DropdownMenuItem(value: u, child: Text(u.fullName)))
                    .toList(),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (task.file != null && task.file!.isNotEmpty) ...[
            ...
            Row(children: [
              ...
              const Text('Submitted file attached',
