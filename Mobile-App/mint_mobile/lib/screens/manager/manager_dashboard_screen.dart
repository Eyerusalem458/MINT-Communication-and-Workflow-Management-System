...
class _ManagerDashboardScreenState extends State<ManagerDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // FIX: removed unused `user` variable — was causing unused_local_variable warning
          ...
          child: Column(children: [
            ...
            SectionCard(
              ...
              child: tasks.tasks.isEmpty
                  ? const EmptyState(
                      message: 'No tasks yet', icon: Icons.task_outlined)
                  : Column(
