    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [Tab(text: 'Tasks'), Tab(text: 'Projects')],
        ),
      ),
      body: TabBarView(
        controller: _tabs,
                ...
                child: Column(children: [
                  ...
                  ...tasks.tasks
                      .where((t) =>
                          ...
                          t.assigneeName.toLowerCase().contains(_taskFilter))
                      .take(20)
                      .map((t) => Container(
              ...
              SectionCard(
                ...
                child: Column(children: [
                  SearchInput(
                      ...
                      onChanged: (v) =>
                          setState(() => _projectFilter = v.toLowerCase())),
                  const SizedBox(height: 12),
                  ...projects.projects
                      .where((p) =>
                          p.title.toLowerCase().contains(_projectFilter) ||
                          p.createdByName
                              .toLowerCase()
