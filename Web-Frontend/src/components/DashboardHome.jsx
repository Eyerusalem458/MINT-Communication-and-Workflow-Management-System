    ...
    <>
      <div className="staff-welcome">
        ...
        <p className="staff-welcome-subtitle">
          Track your tasks, collaborate with your team, and keep projects moving for MINT.
        </p>
      </div>
      ...
      <div className="staff-grid staff-grid--cols-3">
        <div className="staff-card staff-card--metric">
          ...
          <div className="staff-card-caption">Tasks assigned to you this period</div>
        </div>
        <div className="staff-card staff-card--metric">
          <div className="staff-card-label">In Progress</div>
          <div className="staff-card-value staff-card-value--warning">{inProgress}</div>
          <div className="staff-card-caption">Stay focused on high-priority work</div>
        </div>
        <div className="staff-card staff-card--metric">
          <div className="staff-card-label">Completed</div>
          <div className="staff-card-value staff-card-value--success">{completed}</div>
          <div className="staff-card-caption">Great progress towards MINT objectives</div>
        </div>
      </div>
      ...
      <div className="staff-grid staff-grid--cols-2">
        <div className="staff-card">
          ...
          <div className="staff-chart">
            {[
              { label: "Completed", value: completed, cls: "staff-chart-bar-fill--success" },
              { label: "In Progress", value: inProgress, cls: "staff-chart-bar-fill--warning" },
              { label: "Pending", value: pending, cls: "staff-chart-bar-fill--muted" },
            ].map((row) => (
