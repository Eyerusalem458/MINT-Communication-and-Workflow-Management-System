...
// Mock conversations for admin (with Amharic for language toggle)
...
// Sidebar section component (shared layout)
import { FaComments, FaFolder, FaEnvelope } from "react-icons/fa";

export function SidebarSection({ label, type, count, active, onClick, extraButton }) {
...
function Chat() {
  ...
  // Replace flag with text for language toggle
  ...
  // Filtered messages for active person
